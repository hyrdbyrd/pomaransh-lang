...
void markspeep(VM *vm) {
    // Catch parent (not copy, get by reference)
    // &*Object == Object --> Object *obj = &Object;
    Object **object = &vm->firstObject;

    // While we have object in memory (we get original object)
    while (*object)
        if (!(*object)->marked) {
